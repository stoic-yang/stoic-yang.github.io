...
`在hexo创建md文件——hexo new ...` -> `在obsidian写好笔记` -> `复制笔记到md文件上` -> `hexo clean，hexo generate，hexo deploy`
...
所以为什么会渲染不出来呢？第一 hexo 不支持渲染 `![[ ... ]]` 的图片格式，另外你的图片在你的 obsidian 仓库本地，你没搬上 hexo 文件夹上。
...
[二分查找](https://stoic-yang.github.io/2024/12/12/%E4%BA%8C%E5%88%86%E6%9F%A5%E6%89%BE/)
...
![](obsidian+hexo笔记流-20250227201347079.png)
...
![](obsidian+hexo笔记流-20250310103424487.png)
...
![](obsidian+hexo笔记流-20250310103733400.png)
...
`obsidian内创建笔记+写标题` + `alt+I插入模板` + `写笔记` + `alt+P发布笔记`
...
```md
例如![](obsidian+hexo笔记流-20250310103733400.png)
```
你需要调整一下你的设置
![](obsidian+hexo笔记流-20250310105312955.png)
...
在配置中调整一下，你可以照着我的配置抄
![](obsidian+hexo笔记流-20250310105912150.png)
...
这一点你可以直接看主题作者的教程 [Step.4 主题特殊功能 - Theme Shoka Documentation - 二进制杂谈 - 计算机科学 | Yume Shoka = 有夢書架 = 吾乃天，壶中之天](https://shoka.lostyu.me/computer-science/note/theme-shoka-doc/special/)
...
[Step.4 主题特殊功能 - Theme Shoka Documentation - 二进制杂谈 - 计算机科学 | Yume Shoka = 有夢書架 = 吾乃天，壶中之天](https://shoka.lostyu.me/computer-science/note/theme-shoka-doc/special/)
